...
usersRouter.put("/admin/Professor/:id",authenticateToken, editProfessorHandler);
usersRouter.delete("/admin/Professor/:id",authenticateToken, deleteProfessorHandler);
...
usersRouter.delete("/admin/student/:id",authenticateToken, deleteStudentHandler);
...
usersRouter.delete("/admin/manager/:id",authenticateToken, deleteEDUManagerHandler);
